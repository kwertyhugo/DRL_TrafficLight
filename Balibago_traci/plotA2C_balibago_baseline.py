...
FILES_TO_PLOT = {
    'Baseline Agent': 'South_A2C_baseline_history.csv',
}
...
def plot_agent_history(agent_name, csv_path):
    """Loads, processes, and plots the A2C history for a single baseline agent."""
...
def main():
    print("=" * 70)
    print("Generating A2C training plots for Balibago (Baseline)...")
