...
Sumo_config = [
    'sumo',
    '-c', r'Balibago_traci\baselinePed.sumocfg',
    '--step-length', '0.05',
    '--delay', '0',
    '--lateral-resolution', '0.1',
    '--statistic-output', r'Balibago_traci\output_DDPG\baseline_normal_SD_DDPG_stats.xml',
    '--tripinfo-output', r'Balibago_traci\output_DDPG\baseline_normal_SD_DDPG_trips.xml'
]
...
if TRAIN_MODE == 1:
    ...
    save_history('./Balibago_traci/output_DDPG/baseline_main_agent_history.csv', 
