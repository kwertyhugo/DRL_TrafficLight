...
# === OUTPUT DIRECTORIES ===
os.makedirs('./Balibago_traci/output_NoDRL_baseline', exist_ok=True)
...
scenarios = [
    {
        ...
        'stats'     : 'Balibago_traci/output_NoDRL_baseline/SD_NoDRL_baseline_normal_stats.xml',
        'trips'     : 'Balibago_traci/output_NoDRL_baseline/SD_NoDRL_baseline_normal_trips.xml',
    },
    {
        'name'      : 'slow',
        'route_file': 'Balibago_traci/demand/flows_slow_traffic.rou.xml',
        'stats'     : 'Balibago_traci/output_NoDRL_baseline/SD_NoDRL_baseline_slow_stats.xml',
        'trips'     : 'Balibago_traci/output_NoDRL_baseline/SD_NoDRL_baseline_slow_trips.xml',
    },
    {
        'name'      : 'jam',
        'route_file': 'Balibago_traci/demand/flows_jam_traffic.rou.xml',
        'stats'     : 'Balibago_traci/output_NoDRL_baseline/SD_NoDRL_baseline_jam_stats.xml',
        'trips'     : 'Balibago_traci/output_NoDRL_baseline/SD_NoDRL_baseline_jam_trips.xml',
    },
]
...
def run_scenario(scenario):
    ...
    print("\n" + "=" * 70)
    print(f"NO-DRL BASELINE - BASELINE NETWORK  [ {scenario['name'].upper()} TRAFFIC ]")
    print("=" * 70)
    print("Configuration:")
    ...
    print("  - North cycle: 45 / 130 / 30 / 90 s green phases (8-phase)")
    print("  - South cycle: 30 / 30  / 45 s green phases    (6-phase)")
    print("=" * 70 + "\n")
