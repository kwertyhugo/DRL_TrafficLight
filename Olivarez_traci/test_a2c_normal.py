...
if trainMode == 1:
    ...
    Sumo_config = [
        ...
        '--delay', '0',
        '--lateral-resolution', '0.1',
        '--statistic-output', r'Olivarez_traci\output_A2C\SP_A2C_Unified_Normal_stats.xml',
        '--tripinfo-output', r'Olivarez_traci\output_A2C\SP_A2C_Unified_Normal_trips.xml'
    ]
