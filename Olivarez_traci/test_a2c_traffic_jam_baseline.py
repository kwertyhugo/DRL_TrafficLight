...
Sumo_config = [
    ...
    '--statistic-output', r'Olivarez_traci\output_A2C_Baseline\SP_A2C_Baseline_Jam_stats.xml',
    '--tripinfo-output', r'Olivarez_traci\output_A2C_Baseline\SP_A2C_Baseline_Jam_trips.xml'
]
...
print("  - Outputs: SP_A2C_Baseline_Jam_stats.xml, SP_A2C_Baseline_Jam_trips.xml")
print("=" * 70 + "\n")
