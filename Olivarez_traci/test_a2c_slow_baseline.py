...
Sumo_config = [
    ...
    '--statistic-output', r'Olivarez_traci\output_A2C_Baseline\SP_A2C_Baseline_Slow_stats.xml',
    '--tripinfo-output', r'Olivarez_traci\output_A2C_Baseline\SP_A2C_Baseline_Slow_trips.xml'
]
...
print("\n" + "=" * 70)
print("TESTING BASELINE A2C AGENT ON SLOW TRAFFIC SCENARIO")
print("=" * 70)
print("Configuration:")
...
print("  - Outputs: SP_A2C_Baseline_Slow_stats.xml, SP_A2C_Baseline_Slow_trips.xml")
print("=" * 70 + "\n")
...
while traci.simulation.getMinExpectedNumber() > 0:
    ...
    # Early stop if no vehicles remain
    if traci.simulation.getMinExpectedNumber() == 0:
        print("All vehicles processed. Stopping simulation.")
        break
...
print(f"\nOutput files saved:")
print(f"  - Statistics: Olivarez_traci/output_A2C_Baseline/SP_A2C_Baseline_Slow_stats.xml")
print(f"  - Trip Info: Olivarez_traci/output_A2C_Baseline/SP_A2C_Baseline_Slow_trips.xml")
