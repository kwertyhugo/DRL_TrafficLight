"""
run_BanlicMamatid_DDPG_batch_test.py
...
for scenario in ["normal", "slow", "jam"]:
    for i in range(1, 11):
        TEST_PLAN.append({
            ...
            "trips_out": os.path.join(OUTPUT_DIR, f"DDPG_trips_{scenario}_{i:02d}.xml"),
            "stats_out": os.path.join(OUTPUT_DIR, f"DDPG_stats_{scenario}_{i:02d}.xml"),
        })
